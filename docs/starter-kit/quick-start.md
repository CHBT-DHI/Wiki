...
- WEST is installed and licensed. See [Installation](../manuals/installation.md) if not.
...
- Run a parameter study: [Advanced Simulations](../manuals/advanced-simulations.md)
- Add a controller: [Controllers](../manuals/controllers.md)
- Understand the biological model used: [Process Models](../technical-reference/process-models.md)
